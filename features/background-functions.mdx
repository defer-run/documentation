...
A Background functions can be defined as a [CRON](/features/cron), [executed as delayed](/features/delays), and composed to build a [Workflow](/features/workflows).
...
As covered in ["How Defer works?"](/platform/overview), a call to a Background function
...
[concurrency](/features/concurrency)) and [workflow development patterns](/features/workflows).
