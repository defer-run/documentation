...
```tsx remix/app/routes/helloWorld.ts
...
If you are wondering how calling a background function triggers an execution on Defer Platform, please refer to this guide: [How Defer works](/get-started/concepts).

</Callout>

Once your Remix Controller route is defined, please commit and push it to your branch.

Now that your Remix app contains a background function and an API route that calls it, let's ensure that your Defer token is configured correctly.
...
Now, with your API deployment containing your Defer Token and your project's builds ready on Defer, open your browser and test the Remix Controller route.
