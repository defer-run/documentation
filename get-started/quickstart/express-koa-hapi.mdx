...
In an Express/Koa/hapi app, we recommend creating an `src/defer/` folder as follows:
...
Now, with your API deployment containing your Defer Token and your project's builds ready on Defer, open your browser and test your `/helloWorld` API route.
