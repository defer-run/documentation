...
following example showcasing how to call `helloWorld()`, from a SvelteKit
...
Defer Platform, please refer to this guide:
[How Defer works](/get-started/concepts).

</Callout>

Once your SvelteKit server route is defined, please commit and push it to your
branch.

Now that your SvelteKit app contains a background function and an API route that
...
builds ready on Defer, open your browser and test the SvelteKit route.

In the `helloWorld()` background function scenario, visit the `/hello-world`
route.
