...
Given this limitation, the following [`@defer/client`](/references/overview)
APIs are not supported locally:

- [`delay()`](/references/defer-client/v1/delay): will result in executing the
  function immediately
- [`defer.cron()`](/references/defer-client/v1/defer-cron): CRONs do not get
  scheduled locally. You can still test them like regular defer functions
  though.
