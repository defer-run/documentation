...
Your API deployment should expose your [Defer Token](/get-started/concepts) as
an environment variable in order to get your background function deferred when
called.
