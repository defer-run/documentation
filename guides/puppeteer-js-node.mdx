...
description: "Leverage Defer's native puppeteer support with custom resources and long-running executions."
---

Scraping the web with Node.js is resource-intensive. It is also [nearly impossible](https://gist.github.com/kettanaito/56861aff96e6debc575d522dd03e5725) to achieve on a Serverless platform such as Vercel. Likewise, using a large framework like Playwright is overkill for such a common and essentially simple idea.
