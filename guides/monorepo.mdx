...
<Note>
  ...
  with: ```bash pnpm dlx create-turbo@latest ``` You don't have to use Turborepo
  or pnpm to follow this guide though.
</Note>

## 1. Identifying your workspaces

If you already have a monorepo setup, you can skip to
[2. Create a defer folder](#create-a-defer-folder).
...
optimize bundle only those and their dependencies.

</Note>

That's it, you are now fully set up to leverage the power on Defer on your
Turborepo! 🎉
