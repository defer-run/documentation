...
Once the builder as downloaded your project, it starts looking for a `/defer` folder containing your
  background functions files (one file per function since `default` export is used).
