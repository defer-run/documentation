...
Using Nest Services from background functions requires some minor plumbing work since background functions behave as what Nest calls ["Standalone app"](https://docs.nestjs.com/standalone-applications).
