...
Now that your RedwoodJS contains a background function and a serverless function that calls it, let's ensure that your Defer token is properly configured.
