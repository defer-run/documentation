...
Learn how to setup Defer with Next.js and trigger your first background function.
...
- api
 +-- db
 +-- src
  +-- functions                // API endpoints to invoke jobs
      +- <>
  +-- graphql
...
Then, open your browser and visit the `http://localhost:8910/.redwood/functions/hellow?name=Charly` route.
...
Now, with your API deployment containing your Defer Token and your project's builds ready on the Defer Platform, open your browser and test the Next.js API Route.

In the scenario of the `helloWorld()` background function, visit the `/.redwood/functions/helloWorld` route of your deployed application.
