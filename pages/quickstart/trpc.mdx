...
Learn how to setup Defer with tRPC and trigger your first background function.
...
In a tRPC/t3 app, we recommend creating an `defer/` folder as follows:
...
```tsx filename="src/server/api/routers/example.ts" {1, 6} copy
...
Now, with your API deployment containing your Defer Token and your project's builds ready on the Defer Platform, open your browser and test the tRPC route.
